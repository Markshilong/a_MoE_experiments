...
#
# 
# deepspeed --num_gpus 1 /home/mark/Research/accelerate/examples/blenderbot_90M.py
# or:
# python -m torch.distributed.run --nproc_per_node=1 blenderbot_90M.py
#
# To deploy on 2 gpus:
#
# deepspeed --num_gpus 2 blenderbot_90M.py
# or:
# python -m torch.distributed.run --nproc_per_node=2 blenderbot_90M.py
